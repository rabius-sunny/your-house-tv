    ...
    <Background>
      <div className='box max-w-7xl'>
        ...
        <div className='mb-8'>
          <Link
            href='/blogs'
            className='inline-flex mt-3 items-center gap-2 text-gray-300 hover:text-white transition-colors duration-200'
          >
...
function BlogContent({ blog }: { blog: Blog }) {
  return (
    <>
      ...
      {/* Article Content */}
      <div className='grid grid-cols-4 gap-10 lg:gap-6 relative items-start'>
        <div className='col-span-4 lg:col-span-3'>
          <div className='text-gray-100 leading-8 tracking-wide'>
            {parse(blog?.description || '')}
          </div>
        </div>
        <div className='col-span-4 lg:col-span-1 lg:sticky lg:top-10 max-w-sm mx-auto '>
          <Share />
        </div>
      </div>
